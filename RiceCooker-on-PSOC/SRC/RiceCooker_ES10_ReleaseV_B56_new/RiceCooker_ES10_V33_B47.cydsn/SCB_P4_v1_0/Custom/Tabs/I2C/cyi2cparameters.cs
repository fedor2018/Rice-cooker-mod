...
namespace SCB_P4_v1_0
{
    ...
    public partial class CyParamNames
    {
        ...
        public const string I2C_HCLK_FREQ_KHZ = "I2cHclkFreqKHz";
        //public const string I2C_PSVP_CLOCKS = "PSVP_Clocks";
    }
    #endregion
    ...
    public partial class CyParamRanges
    {
        ...
        private const byte I2C_OVS_FACTOR_MEDFILTER_MIN = 8;
        private const byte I2C_OVS_FACTOR_NOMEDFILTER_MIN = 6;
        public const byte I2C_OVS_FACTOR_MAX = 32;

        private const byte I2C_OVS_LOW_HIGH_MEDFILTER_MIN = 4;
        private const byte I2C_OVS_LOW_HIGH_NOMEDFILTER_MIN = 3;
        ...
        public static byte GetI2COvsLowHighMinimum(bool medianFilterEnabled)
        {
            return medianFilterEnabled ? CyParamRanges.I2C_OVS_LOW_HIGH_MEDFILTER_MIN :
                CyParamRanges.I2C_OVS_LOW_HIGH_NOMEDFILTER_MIN;
        }
    }
    #endregion
    ...
    {
        public CyEI2CModeType I2C_Mode
        {
            get { return GetValue<CyEI2CModeType>(CyParamNames.I2C_MODE); }
            set { SetValue(CyParamNames.I2C_MODE, value); }
        }
        ...
        public double I2C_HclkFreq
        {
            get { return GetValue<double>(CyParamNames.I2C_HCLK_FREQ_KHZ); }
            set { SetValue(CyParamNames.I2C_HCLK_FREQ_KHZ, value); }
        }
    }
}
