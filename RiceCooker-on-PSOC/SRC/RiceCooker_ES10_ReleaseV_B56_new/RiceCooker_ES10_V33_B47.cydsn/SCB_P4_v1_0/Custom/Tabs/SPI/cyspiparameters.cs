...
namespace SCB_P4_v1_0
{
    ...
    public partial class CyParameters
    {
        ...
        public const UInt16 SPI_MAX_DATA_RATE = 16000;
        ...
        #region Properties
        public CyESPIBitOrderType SPI_BitsOrder
        {
            get { return GetValue<CyESPIBitOrderType>(CyParamNames.SPI_BITS_ORDER); }
            set { SetValue(CyParamNames.SPI_BITS_ORDER, value); }
        }
        ...
        public CyESPISCLKModeType SPI_SCLKMode
        {
            get { return GetValue<CyESPISCLKModeType>(CyParamNames.SPI_SCLK_MODE); }
            set { SetValue(CyParamNames.SPI_SCLK_MODE, value); }
        }
        public CyESPIModeType SPI_Mode
        {
            get { return GetValue<CyESPIModeType>(CyParamNames.SPI_MODE); }
            set { SetValue(CyParamNames.SPI_MODE, value); }
        }
        public CyESPISubModeType SPI_SubMode
        {
            get { return GetValue<CyESPISubModeType>(CyParamNames.SPI_SUB_MODE); }
