...
namespace SCB_P4_v1_0
{
    ...
    public partial class CyParamNames
    {
        ...
        public const string UART_LOW_POWER_TRANSMIT = "UartIrdaLowPower";
        ...
        public const string UART_SKIP_START = "UartSkipStart";
    ...
    public partial class CyParamRanges
    {
        ...
        public const UInt32 UART_DATA_RATE_MAX_VALUE = 921600;
    }
    #endregion
    ...
    public partial class CyParameters
    {
        ...
        public CyEUARTSubModeType UART_SubMode
        {
            get { return GetValue<CyEUARTSubModeType>(CyParamNames.UART_SUB_MODE); }
            set { SetValue(CyParamNames.UART_SUB_MODE, value); }
        }

        public CyEUARTDirectionType UART_Direction
        {
            get { return GetValue<CyEUARTDirectionType>(CyParamNames.UART_DIRECTION); }
            set { SetValue(CyParamNames.UART_DIRECTION, value); }
        }
        ...
        public CyEUARTNumberDataBitsType UART_NumberDataBits
        {
            get { return GetValue<CyEUARTNumberDataBitsType>(CyParamNames.UART_NUMBER_OF_DATA_BITS); }
            set { SetValue(CyParamNames.UART_NUMBER_OF_DATA_BITS, value); }
        }

        public CyEUARTParityType UART_ParityType
        {
            get { return GetValue<CyEUARTParityType>(CyParamNames.UART_PARITY_TYPE); }
            set { SetValue(CyParamNames.UART_PARITY_TYPE, value); }
        }

        public CyEUARTNumberStopBitsType UART_NumberStopBits
        {
            get { return GetValue<CyEUARTNumberStopBitsType>(CyParamNames.UART_NUMBER_OF_STOP_BITS); }
            set { SetValue(CyParamNames.UART_NUMBER_OF_STOP_BITS, value); }
        }
        ...
        public bool UART_LowPowerTransmitting
        {
            get { return GetValue<bool>(CyParamNames.UART_LOW_POWER_TRANSMIT); }
            set { SetValue(CyParamNames.UART_LOW_POWER_TRANSMIT, value); }
        }
